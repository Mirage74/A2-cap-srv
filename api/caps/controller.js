...
const LOGIN_MIN_LENGTH = require('../../config/config.js').LOGIN_MIN_LENGTH;
const LOGIN_MAX_LENGTH = require('../../config/config.js').LOGIN_MAX_LENGTH;
...
exports.getCapsByID = async (req, res) => {
  if (!req.params.id) {
...
exports.postUserScore = async (req, res) => {
